...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::middleware('roleManager:admin')->group(function () {
        ...
        Route::get('/dashboard/admin', [DashboardController::class, 'index'])->name('admin.dashboard'); // Admin dashboard
         ...
         Route::resource('productHistory', ProductHistoryController::class);
         ...
         Route::get('/update-product-price-qty/{id}', [ProductController::class, 'updateProductQtyPrice'])->name('updateProductQtyPrice');
