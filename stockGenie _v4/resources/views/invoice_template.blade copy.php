...
<body>
    <div class="invoice-box">
        <div class="logo">
            <img src="{{ asset('images/logo/StockGenie.png') }}" alt="Company Logo">
        </div>
        <table cellpadding="0" cellspacing="0">
                    ...
                    <table>
                        <tr>
                            ...
                            <td colspan="3" style="text-align: right;">
                                    ...
                                    Invoice #: @foreach($contentsCart as $id)
                                    {{ $id->id }}
                                    @endforeach<br>
            ...
            <tr class="tax">
                <td colspan="3"></td>
                $currency = Number::currency({{ $data['vat'] }}, in: 'BDT');
                <td>VAT (10%): {{  $currency}}</td>

            </tr>
            
            <tr class="total">
                <td colspan="3"></td>
                <td>Grand Total: {{ $data['total'] }}৳</td>
            </tr>
