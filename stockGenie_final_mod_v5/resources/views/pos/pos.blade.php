					...
					<div class="modal-body">
						<div class="row">
							...
							<div class="col-md-4">
								...
								<input type="number" name="pay" id="pay" class="form-control" step="0.01" required>
												...
												<form action="{{URL::to('/update-card/'.$p->rowId)}}" method="post">
													...
													<div class="qty" style="">
														...
														<button type="submit" class="btn btn-success  waves-effect waves-light m-0 p-0" style="display: flex;
															justify-content: center;
															align-items: center;">
															<i class="md md-done-all" style="font-size: 20px;    margin: 2px;"></i>
														</button>
													</div>
												</form>
											</td>
						...
						<table id="dataTable" class="table table-striped table-bordered">
							...
							<tbody>
								...
								<tr style="text-align: center !important;">
									<td >
										<form action="{{ URL::to('/add-card') }}" method="post">
											...
											<button type="submit" class="btn btn-primary" class="c-btn">
												<i class="md md-add-shopping-cart" style="font-size:20px"></i>
											</button>
										</form>
									</td>
									...
									<td >
										<p class="btn btn-{{ $row->product_qty < 5 ? 'danger' : 'success' }} shadow-none text-white" style="" >{{
											$row->product_qty
											}}</p>
									</td>
