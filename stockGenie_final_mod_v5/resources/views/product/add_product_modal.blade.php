                        ...
                        <div class="row m-3">
                            ...
                            <div class="col-md-12 col-lg-4 mb-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('product_name') is-invalid @enderror" name="product_name" placeholder="Enter Name" value="{{old('product_name')}}" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="product_qty" value="{{old('product_qty')}}" placeholder="Enter Product Quantity" required>
                            ...
                            <div class="col-md-12 col-lg-4 mb-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="selling_price" value="{{old('selling_price')}}" placeholder="Enter Product Selling Prize" required>
                        ...
                        <div class="row m-3">
                            <div class="col-lg-6 mb-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="tel" class="form-control" name="phone" placeholder="Enter Phone Number" value="{{ old('phone') }}"  required/>
                            ...
                            <div class="col-lg-6 mb-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="shopName" placeholder="Enter Shop Name" value="{{ old('shopName') }}"  required/>
