	...
	<div class="col-md-12">
		<div class="panel panel-success">
			...
			<div class="panel-heading ">
				...
				<div class="top mx-2" style="display: flex;justify-content: space-between; align-items:center;margin-bottom:10px">
							...
							<table id="dataTable" class="table table-striped table-bordered">
								...
								<tbody>
									...
									<tr>
										...
										<td>{{$row->amount}}</td>
										<td>
											<a href="{{URL::to('/edit-expense/'.$row->id)}}" class="btn btn-sm btn-info fs-4"><i class="fa fa-pencil-square-o fs-2"></i></a>
											<a href="{{URL::to('/delete-expense/'.$row->id)}}" class="btn btn-sm btn-danger fs-4"
												id="delete"><i class="fa fa-trash-o fs-2"></i></a>
										</td>
									</tr>
									@endforeach
								</tbody>
