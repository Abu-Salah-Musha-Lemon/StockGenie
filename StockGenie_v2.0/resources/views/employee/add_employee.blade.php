	...
	<div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
		<div class="panel panel-info">
			<div class="panel-heading" style="display: flex; justify-content: space-between;">
				...
				<a class="panel-title fs-4" href="{{route('admin.employees.index')}}">
						...
						<div class="col-12 col-sm-12 col-md-4 mb-4">
							...
							<div class="form-group">
								...
								<input type="text" class="form-control @error('nid') is-invalid @enderror" name="nid"
									placeholder="Enter nid Number" value="{{old('nid')}}" required>
							...
							<div class="form-group">
								...
								<input type="tel" pattern="[0-9]{3}[0-9]{4}[0-9]{4}"
									...
									placeholder="Enter Your Phone Number (01978977465)" value="{{old('phone_number')}}" required>
						...
						<div class="col-12 col-sm-12 col-md-4 ">
							...
							<div class="form-group">
								...
								<input type="text" class="form-control @error('vacation') is-invalid @enderror" name="vacation"
									placeholder="Enter vacation" value="{{old('vacation')}}" required>
