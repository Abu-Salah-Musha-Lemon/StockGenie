...
class ProductHistoryController extends Controller
{
    ...
    public function index()
    {
        ...
        ->join('users','product_histories.updated_by','=','users.id')
        ->select('products.*','product_histories.*', 'suppliers.name as supplier_name', 'suppliers.id as suppliers_id','users.name as user_name')  // Aliasing the supplier name and id properly
